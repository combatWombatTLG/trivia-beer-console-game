...
javac -d classes -classpath "lib\*" src\com\combatWombat\view\*.java src\com\combatWombat\controller\*.java src\com\combatWombat\model\*.java
...
jar --create --file trivia_beer_console_game.jar -C classes .
